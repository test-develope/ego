<template>
  <div>
      <!-- 
          title="添加商品"  弹框的标题
          :visible.sync="dialogVisible  控制弹框显示或者隐藏
          接收boolean  true显示
       -->
      <el-dialog
         center
      ...
      <!-- 内容区域 -->
        ...
        <el-form-item label="商品名称" prop="title">
            <el-input v-model.trim="goodsForm.title" placeholder="请输入商品名称"></el-input>
        </el-form-item>
        <el-form-item label="商品价格" prop="price">
            <el-input v-model="goodsForm.price" placeholder="请输入商品价格"></el-input>
        </el-form-item>
         <el-form-item label="商品数量" prop="num">
            <el-input v-model.number="goodsForm.num" placeholder="请输入商品数量"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商品卖点" prop="sellPoint">
            <el-input v-model.trim="goodsForm.sellPoint" placeholder="请输入商品卖点"></el-input>
        </el-form-item>
